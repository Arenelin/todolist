import {v1} from 'uuid';
import {
    addTodolist, changeTodolistEntityStatus, changeTodolistFilter, changeTodolistName,
...
test('correct entity status of todolist should be changed', () => {
    ...
    const endState =
        todolistsReducer(startState, changeTodolistEntityStatus(todolistId1, newStatus))
